...
function busq_sueld_mensual(e){
  ...
  let dni_emp_verif = isNaN(dni_emp);

  if (dni_emp == "" || dni_emp_verif) {
    Swal.fire("Ingrese un DNI correcto o revise los datos ingresados");
  }
  ...
  switch (mes_selec) {
    case "Enero":
      if ((anio = 2022)) {
        ...
        if (ene22_par == null) {
          Swal.fire("No se encuentra cargado el sueldo en el mes seleccionado");
        } else {
          for (i = 0; i < ene22_par.length; i++) {
            if (ene22_par[i].dni == dni_emp) {
              ...
              i == ene22_par.length - 1 &&
              ene22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (ene23_par == null) {
          ...
          for (i = 0; i < ene23_par.length; i++) {
            if (ene23_par[i].dni == dni_emp) {
              ...
              i == ene23_par.length - 1 &&
              ene23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (feb22_par == null) {
          ...
          for (i = 0; i < feb22_par.length; i++) {
            if (feb22_par[i].dni == dni_emp) {
              ...
              i == feb22_par.length - 1 &&
              feb22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (feb23_par == null) {
          ...
          for (i = 0; i < feb23_par.length; i++) {
            if (feb23_par[i].dni == dni_emp) {
              ...
              i == feb23_par.length - 1 &&
              feb23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (mar22_par == null) {
          ...
          for (i = 0; i < mar22_par.length; i++) {
            if (mar22_par[i].dni == dni_emp) {
              ...
              i == mar22_par.length - 1 &&
              mar22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (mar23_par == null) {
          ...
          for (i = 0; i < mar23_par.length; i++) {
            if (mar23_par[i].dni == dni_emp) {
              ...
              i == mar23_par.length - 1 &&
              mar23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (abr22_par == null) {
          ...
          for (i = 0; i < abr22_par.length; i++) {
            if (abr22_par[i].dni == dni_emp) {
              ...
              i == abr22_par.length - 1 &&
              abr22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (abr23_par == null) {
          ...
          for (i = 0; i < abr23_par.length; i++) {
            if (abr23_par[i].dni == dni_emp) {
              ...
              i == abr23_par.length - 1 &&
              abr23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (may22_par == null) {
          ...
          for (i = 0; i < may22_par.length; i++) {
            if (may22_par[i].dni == dni_emp) {
              ...
              i == may22_par.length - 1 &&
              may22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (may23_par == null) {
          ...
          for (i = 0; i < may23_par.length; i++) {
            if (may23_par[i].dni == dni_emp) {
              ...
              i == may23_par.length - 1 &&
              may23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (jun22_par == null) {
          ...
          for (i = 0; i < jun22_par.length; i++) {
            if (jun22_par[i].dni == dni_emp) {
              ...
              i == jun22_par.length - 1 &&
              jun22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (jun23_par == null) {
          ...
          for (i = 0; i < jun23_par.length; i++) {
            if (jun23_par[i].dni == dni_emp) {
              ...
              i == jun23_par.length - 1 &&
              jun23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (jul22_par == null) {
          ...
          for (i = 0; i < jul22_par.length; i++) {
            if (jul22_par[i].dni == dni_emp) {
              ...
              i == jul22_par.length - 1 &&
              jul22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (jul23_par == null) {
          ...
          for (i = 0; i < jul23_par.length; i++) {
            if (jul23_par[i].dni == dni_emp) {
              ...
              i == jul23_par.length - 1 &&
              jul23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (ago22_par == null) {
          ...
          for (i = 0; i < ago22_par.length; i++) {
            if (ago22_par[i].dni == dni_emp) {
              ...
              i == ago22_par.length - 1 &&
              ago22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (ago23_par == null) {
          ...
          for (i = 0; i < ago23_par.length; i++) {
            if (ago23_par[i].dni == dni_emp) {
              ...
              i == ago23_par.length - 1 &&
              ago23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (sep22_par == null) {
          ...
          for (i = 0; i < sep22_par.length; i++) {
            if (sep22_par[i].dni == dni_emp) {
              ...
              i == sep22_par.length - 1 &&
              sep22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (sep23_par == null) {
          ...
          for (i = 0; i < sep23_par.length; i++) {
            if (sep23_par[i].dni == dni_emp) {
              ...
              i == sep23_par.length - 1 &&
              sep23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (oct22_par == null) {
          ...
          for (i = 0; i < oct22_par.length; i++) {
            if (oct22_par[i].dni == dni_emp) {
              ...
              i == oct22_par.length - 1 &&
              oct22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (oct23_par == null) {
          ...
          for (i = 0; i < oct23_par.length; i++) {
            if (oct23_par[i].dni == dni_emp) {
              ...
              i == oct23_par.length - 1 &&
              oct23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (nov22_par == null) {
          ...
          for (i = 0; i < nov22_par.length; i++) {
            if (nov22_par[i].dni == dni_emp) {
              ...
              i == nov22_par.length - 1 &&
              nov22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (nov23_par == null) {
          ...
          for (i = 0; i < nov23_par.length; i++) {
            if (nov23_par[i].dni == dni_emp) {
              ...
              i == nov23_par.length - 1 &&
              nov23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (dic22_par == null) {
          ...
          for (i = 0; i < dic22_par.length; i++) {
            if (dic22_par[i].dni == dni_emp) {
              ...
              i == dic22_par.length - 1 &&
              dic22_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
        ...
        if (dic23_par == null) {
          ...
          for (i = 0; i < dic23_par.length; i++) {
            if (dic23_par[i].dni == dni_emp) {
              ...
              i == dic23_par.length - 1 &&
              dic23_par[i].dni != dni_emp
            ) {
              divcopia.innerHTML = `
...
//Funcion que toma del local Storage los valores almacenados del dolar y del sueldo final del empleado, luego hace la conversion y lo muestra en pantalla agregandolo al html. Toma un promedio entre dolar venta  y dolar compra
